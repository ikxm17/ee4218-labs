...
entity myip_v2_0_HLS_fifo_w32_d2_S is 
    generic (
...
architecture rtl of myip_v2_0_HLS_fifo_w32_d2_S is
...
------------------------Component----------------------
    component myip_v2_0_HLS_fifo_w32_d2_S_ShiftReg is
    generic (
        DATA_WIDTH : integer := 32;
        ADDR_WIDTH : integer := 2;
        DEPTH      : integer := 2);
...
begin
----------------------- Instantiation -----------------------
    U_myip_v2_0_HLS_fifo_w32_d2_S_ShiftReg : myip_v2_0_HLS_fifo_w32_d2_S_ShiftReg
    generic map (
...
entity myip_v2_0_HLS_fifo_w32_d2_S_ShiftReg is
    generic (
        DATA_WIDTH : integer := 32;
        ADDR_WIDTH : integer := 2;
        DEPTH      : integer := 2);
    port (
        ...
        din        : in std_logic_vector(DATA_WIDTH-1 downto 0);
        dout       : out std_logic_vector(DATA_WIDTH-1 downto 0));
end myip_v2_0_HLS_fifo_w32_d2_S_ShiftReg;

architecture rtl of myip_v2_0_HLS_fifo_w32_d2_S_ShiftReg is
