...
entity myip_v2_0_HLS_flow_control_loop_pipe is
port (
    ap_clk             : in  std_logic;
    ap_rst             : in  std_logic;
...
end entity myip_v2_0_HLS_flow_control_loop_pipe;

architecture behav of myip_v2_0_HLS_flow_control_loop_pipe is
