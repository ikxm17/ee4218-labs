...
TOOLCHAIN += --gcc-toolchain=/opt/Xilinx/2025.2/Vitis/tps/lnx64/gcc-8.3.0
...
$(ObjDir)/test_myip_v2_0_HLS.cpp_pre.cpp.tb.o : test_myip_v2_0_HLS.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling test_myip_v2_0_HLS.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
...
$(ObjDir)/myip_v2_0_HLS.cpp_pre.cpp.tb.o : myip_v2_0_HLS.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling myip_v2_0_HLS.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
