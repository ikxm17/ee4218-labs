...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "myip_v2_0_HLS.autotvin.dat"
	set constFileTvOut       "myip_v2_0_HLS.autotvout.dat"
	set constFileHdlTvIn     "myip_v2_0_HLS.autohdltvin.dat"
	set constFileHdlTvOut    "myip_v2_0_HLS.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
