...
if {[file isfile myip_v2_0_HLS.autotvin.dat]} {
	file delete -force myip_v2_0_HLS.autotvin.dat
}

if {[file isfile myip_v2_0_HLS.autotvout.dat]} {
	file delete -force myip_v2_0_HLS.autotvout.dat
}
