...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.myip_v2_0_HLS.autotvin_S_AXIS_V_data_V.dat"
         "c.myip_v2_0_HLS.autotvin_S_AXIS_V_keep_V.dat"
         "c.myip_v2_0_HLS.autotvin_S_AXIS_V_strb_V.dat"
         "c.myip_v2_0_HLS.autotvin_S_AXIS_V_last_V.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.myip_v2_0_HLS.autotvout_M_AXIS_V_data_V.dat"
         "rtl.myip_v2_0_HLS.autotvout_M_AXIS_V_keep_V.dat"
         "rtl.myip_v2_0_HLS.autotvout_M_AXIS_V_strb_V.dat"
         "rtl.myip_v2_0_HLS.autotvout_M_AXIS_V_last_V.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
