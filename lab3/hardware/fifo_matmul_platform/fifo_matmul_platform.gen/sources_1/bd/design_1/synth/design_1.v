...
module design_1
  ...
  wire [31:0]pl_matmul_0_M_AXIS_TDATA;
  wire pl_matmul_0_M_AXIS_TLAST;
  wire pl_matmul_0_M_AXIS_TREADY;
  wire pl_matmul_0_M_AXIS_TVALID;
  ...
  design_1_axi_fifo_mm_s_0_0 axi_fifo_mm_s_0
       (.axi_str_rxd_tdata(pl_matmul_0_M_AXIS_TDATA),
        .axi_str_rxd_tlast(pl_matmul_0_M_AXIS_TLAST),
        .axi_str_rxd_tready(pl_matmul_0_M_AXIS_TREADY),
        .axi_str_rxd_tvalid(pl_matmul_0_M_AXIS_TVALID),
        ...
        .s_axi4_araddr(axi_smc_M01_AXI_ARADDR),
        .s_axi4_arburst(axi_smc_M01_AXI_ARBURST),
        .s_axi4_arcache(axi_smc_M01_AXI_ARCACHE),
        .s_axi4_arid(1'b0),
        .s_axi4_arlen(axi_smc_M01_AXI_ARLEN),
        .s_axi4_arlock(axi_smc_M01_AXI_ARLOCK),
        .s_axi4_arprot(axi_smc_M01_AXI_ARPROT),
        .s_axi4_arready(axi_smc_M01_AXI_ARREADY),
        .s_axi4_arsize(axi_smc_M01_AXI_ARSIZE),
        .s_axi4_arvalid(axi_smc_M01_AXI_ARVALID),
        .s_axi4_awaddr(axi_smc_M01_AXI_AWADDR),
        .s_axi4_awburst(axi_smc_M01_AXI_AWBURST),
        .s_axi4_awcache(axi_smc_M01_AXI_AWCACHE),
        .s_axi4_awid(1'b0),
        .s_axi4_awlen(axi_smc_M01_AXI_AWLEN),
        .s_axi4_awlock(axi_smc_M01_AXI_AWLOCK),
        .s_axi4_awprot(axi_smc_M01_AXI_AWPROT),
        .s_axi4_awready(axi_smc_M01_AXI_AWREADY),
        .s_axi4_awsize(axi_smc_M01_AXI_AWSIZE),
        .s_axi4_awvalid(axi_smc_M01_AXI_AWVALID),
        .s_axi4_bready(axi_smc_M01_AXI_BREADY),
        .s_axi4_bresp(axi_smc_M01_AXI_BRESP),
        .s_axi4_bvalid(axi_smc_M01_AXI_BVALID),
        .s_axi4_rdata(axi_smc_M01_AXI_RDATA),
        .s_axi4_rlast(axi_smc_M01_AXI_RLAST),
        .s_axi4_rready(axi_smc_M01_AXI_RREADY),
        .s_axi4_rresp(axi_smc_M01_AXI_RRESP),
        .s_axi4_rvalid(axi_smc_M01_AXI_RVALID),
        .s_axi4_wdata(axi_smc_M01_AXI_WDATA),
        .s_axi4_wlast(axi_smc_M01_AXI_WLAST),
        .s_axi4_wready(axi_smc_M01_AXI_WREADY),
        .s_axi4_wstrb(axi_smc_M01_AXI_WSTRB),
        .s_axi4_wvalid(axi_smc_M01_AXI_WVALID),
  ...
  design_1_pl_matmul_0_0 pl_matmul_0
       (.ACLK(zynq_ultra_ps_e_0_pl_clk0),
        .ARESETN(rst_ps8_0_99M_peripheral_aresetn),
        .M_AXIS_TDATA(pl_matmul_0_M_AXIS_TDATA),
        .M_AXIS_TLAST(pl_matmul_0_M_AXIS_TLAST),
        .M_AXIS_TREADY(pl_matmul_0_M_AXIS_TREADY),
        .M_AXIS_TVALID(pl_matmul_0_M_AXIS_TVALID),
